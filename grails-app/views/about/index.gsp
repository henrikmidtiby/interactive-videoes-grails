...
<twbs:row>
    <twbs:column>
        ...
        <twbs:row>
            <twbs:column>
                <p>Siden <a href="//tekvideo.sdu.dk">tekvideo.sdu.dk</a> er et forsøg på at lette håndtering af videoer i forbindelse med undervisning på TEK SDU.</p>
                ...
                <p>Kildekoden til siden er tilgængelig under en open source licens på <a href="https://github.com/henrikmidtiby/tekvideo.sdu.dk">github.com</a>.</p>
            </twbs:column>
        </twbs:row>
    </twbs:column>
</twbs:row>
